...
// interacting with the AIDR API. You should not instantiate this client directly,
...
// DefaultClientOptions read from the environment (AIDR_API_TOKEN, AIDR_BASE_URL_TEMPLATE).
// This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{}
	if o, ok := os.LookupEnv("AIDR_BASE_URL_TEMPLATE"); ok {
		defaults = append(defaults, option.WithBaseURLTemplate(o))
	}
	if o, ok := os.LookupEnv("AIDR_API_TOKEN"); ok {
...
// environment (AIDR_API_TOKEN, AIDR_BASE_URL_TEMPLATE). The option passed in as
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.AIGuard = NewAIGuardService(opts...)
